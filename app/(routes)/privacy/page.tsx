  ...
  return (
    <div className="inner_page">
      <Head>
        ...
        <meta
          name="description"
          content="Read BNNGPT's Privacy Policy to learn how we collect, use, and protect your information."
        />
        <meta
          property="og:title"
          content="BNNGPT Privacy Policy - Protecting Your Data and Privacy"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.bnngpt.com/privacy-policy"
        />
      ...
      <p>
        ...
        cover the BNNGPT API, which is subject to the terms outlined in the Data
      ...
      <p>
        ...
        type, broad geographic location (e.g., country or city-level location),
        and other technical information. We may also collect information about
        how your device has interacted with our website, including the pages
        accessed and links clicked. Collecting this information helps us better
        understand the visitors to our website, their locations, and their
        interests. We use this information for internal analytics purposes and
        to improve the quality and relevance of our services.
      </p>
      <p>
        If you create an account on our website, we will collect certain
        information from you, such as your name, email address, and password. We
        use this information to provide you with access to your account and
        customer support.
      </p>
      ...
      <ul>
        <li>
          ...
          providers that perform certain services on our behalf, such as sending
          emails, processing payments, or providing customer support.
        </li>
        <li>
          Analytics Service Providers: We may share anonymized usage information
      ...
      <p>
        ...
        for service continuity, such as sending emails, processing payments, or
        providing customer support.
      </p>
      <p>
        We may use site monitoring tools, such as Cloudflare, Sentry, and Umami,
        to collect anonymized information about usage. These tools may collect
        your IP address, device type, browser type, operating system, geographic
        location, and other technical information. We use this information to
        improve the quality and relevance of our website for our visitors.
      </p>
      <h3>Security</h3>
      <p>
      ...
      <p>
        ...
        data collection for AI improvement purposes in your account settings. If
        you delete your account, we will delete your personal information from
        our servers within 30 days. Please contact us at{' '}
      ...
      <p>
        ...
        post the revised Policy on our website and update the “Last updated”
        date above. We encourage you to review the Policy whenever you access or
        use our Services or otherwise interact with us to stay informed about
